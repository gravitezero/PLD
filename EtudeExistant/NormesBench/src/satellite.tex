...
\section{Nomes et Benchmarking}
		...
		Le benchmarking consiste \'a à  situer GSTP par rapport \'a à  la concurrence. L'objet de ce document est ainsi de repérer les leaders du marchés et de s'inspirer de leur "best practices", leurs fonctionnements et de leurs expériences afin que les pratiques en interne se rapprochent de plus en plus de « la perfection ».
Dans un premier temps, nous nous attacherons \'a à d\'etailler  détailler les entreprises phares du secteur des travaux publics, puis nous nous concentrerons plus spécifiquement aux systèmes informatiques du marché ainsi qu'à ceux mis en place par la concurrence.

		\subsection{Les concurrents et leaders du marché}
		GSTP est une entreprise de travaux, spécialisée dans le terrassement et le génie civil. Elle s'inscrit donc dans le domaine des BTP oà¹ l'on peut citer quelques grands groupes
				\begin{itemize}
...
Il réunit un ensemble de compétences dans les métiers du bà¢timent, du génie civil, des travaux hydrauliques et des services.
...
En effet, le compagnon (terme employé par les chefs de chantier pour parler de leurs ouvriers) ne réalise pas une multitude de tà¢ches, sa mission et son champ d'intervention sur le chantier sont très précis, cela pour des raisons de sécurité, de fiabilité et d'efficacité.
...
sa capacité à  réaliser, mais également concevoir d'important projets de construction aux domaines variés (chemin de fer, bà¢timent, ...).
...
Un management global peut ainsi àªtre entrepris par CRCC. 
...
Ainsi, les machines inutilisées peuvent àªtre louées à  d'autres entreprises et les coà»ts d'immobilisation du matériel s'en trouvent réduits. 
...
ou assurer une maintenance préventive importante et ainsi valoriser le matériel en acceptant qu'il soit parfois immobilisé.
				...
				\subsubsection{Un exemple : Travaux publics bà¢timent boulanger}
...
Nous nous intéresserons ici, plus particulièrement aux divers offres génériques de SAP et SAGE ainsi qu'à  des logiciels spécifiques en BTP.
				\subsubsection{SAGE X3 Edition : un ERP générique visant un large public}
						...
						Objetcifs :
						\begin{itemize}
						    \item Réduire les coà»ts et les délais
				...
				SAP ERP est composé dâ€™une centaine de modules fonctionnels bien précis (Material Management, Sales and Distribution,... ). 
Le principal intéràªt de SAP ERP est quâ€™il est totalement flexible. On peut installer tous les modules fonctionnels, ou seulement quelques-uns. 
Aucun superflux. SAP ERP est entièrement paramétrable et s'adapte ainsi aux besoins et à  la structure de l'entreprise. 
Grà¢ce à  ses fonctionnalités, ce progiciel sâ€™adapte parfaitement au secteur du BTP. 
Enfin, grà¢ce à  son environnement de développement, SAP ERP peut àªtre adapté à  des besoins spécifiques.
